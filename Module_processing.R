...
##########################################################################################################################################
# File Name:     Module_processing.R
# Description:   Calculate variables associated with the processing module
...
data$Prop_wash <- (10^data$F_wash) * (1 + data$F_wash_adj)
...
data$C_chill <- data$C_wash + data$C_wash *data$F_chill

#Number of bacteria on a random product
data$C_proc <- ifelse( data$Product_cut =="no",  
                       data$C_chill, 
                       ifelse(data$Meat_skin =="skin off", 
                              data$C_chill * data$P_skin * data$Prop_cm * data$Prop_product, 
                              data$C_chill * data$Prop_product)) 
