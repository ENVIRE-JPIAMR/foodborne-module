...
production_inputs <- data.frame(
  ...
  Source   = c(
    ...
    "Sarnino et al. (in prep.)",
    "Huijbers et al. (2014); Daniel (2020)",
    "Collineau et al. (2020)",
    "Collineau et al.(2020)", 
    "Bucher et al. (2012)",
    "Collineau et al. (2020)",
    "Berrang et Northcutt (2005)",
    "Collineau et al. (2020)",
    "Bucher et al. (2012)",
    "Bucher et al. (2012)"
  )
...
with reduction rate from @althaus17:
```{r, include=FALSE}
# Production submodule
scalding <- data.frame(
...
carcasses is determined by an additional parameter Prop_product signifying the 
fraction of the raw product that represents the final processed product.
...
pprocessing_calcul <- data.frame(
  ...
  Value    = c(
    ...
    "Based on FIA, Faverjon et al. (2022) and Collineau et al. (2020)",
    "(3) in Collineau et al. (2020) on C_pack",
    "(3) in Collineau et al. (2020) on C_pack",
    "(4) in Collineau et al. (2020) on C_pproc_p",
    "(4) in Collineau et al. (2020) on C_pproc_n"
  )
)
```
```{r}
